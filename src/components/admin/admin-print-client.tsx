    ...
    <div>
      <div className="no-print mb-8">
        ...
        <p className="mt-4 max-w-2xl text-sm text-muted-foreground">
          Recto (QR) et verso (titre, artiste, date). Chaque face imprimée
          mesure 63 × 88 mm — mettre l’échelle d’impression à{" "}
          <span className="font-medium text-foreground">100 %</span>{" "}
          (sans « Ajuster à la page ») pour respecter cette taille. Ctrl+P /
          Cmd+P.
        </p>
      </div>
